---
name: game-feel-playtesting
description: Run blinded comparison tests for controls and feedback with reproducible builds, tasks, metrics, and tuning logs. Use for feel validation.
---
...
5. Produce test protocol, observations, chosen parameters and rationale.
