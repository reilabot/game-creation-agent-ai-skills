---
name: game-control-latency
description: Measure and budget input-to-photon latency, frame pacing, buffering, display, and network delay. Use for latency diagnosis.
---

# game-control-latency
...
5. Produce measurement method, latency budget, before/after captures.
