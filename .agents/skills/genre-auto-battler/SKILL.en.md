---
name: genre-auto-battler
description: Design shops, pools, synergies, formations, deterministic combat, rounds, and economy. Use for auto battlers.
---
...
5. Produce round state machine, pool odds, simulation tests.
