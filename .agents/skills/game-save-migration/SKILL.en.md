---
name: game-save-migration
description: Version, migrate, back up, validate, and recover game saves without player data loss. Use when schemas or persistent content change.
---
...
5. Produce versioned migration, golden saves, rollback and corruption tests.
