---
name: game-authoritative-server
description: Design server-authoritative game state, validation, ownership, replication, interest management, and abuse resistance. Use for competitive or persistent online games.
---
...
5. Produce authority matrix, protocol boundaries, load and security tests.
