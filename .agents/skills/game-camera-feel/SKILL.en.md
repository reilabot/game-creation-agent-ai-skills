---
name: game-camera-feel
description: Tune follow, look-ahead, damping, collision, recentering, framing, and FOV. Use for gameplay camera feel.
---
...
5. Produce camera states, tunable profiles, comfort and occlusion tests.
