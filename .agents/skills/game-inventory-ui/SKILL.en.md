...
description: Design inventory, equipment, loot, drag/drop, comparison, and loss-safe interactions. Use for inventory UI.
---
...
5. Produce interaction states, error recovery, controller/touch tests.
