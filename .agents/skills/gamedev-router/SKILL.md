---
name: gamedev-router
description: Route a game-development goal to the smallest sufficient set of engine, genre, system, art, release, and QA skills. Use after project analysis or when a request crosses game disciplines.
---
...
5. Produce ordered skills, roles, model classes, tools, dependencies, and gates.
