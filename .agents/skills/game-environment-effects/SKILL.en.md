---
name: game-environment-effects
description: Design weather, fog, wind, water, fire, and destruction effects. Use for environmental presentation.
---
...
5. Produce state contract, transitions, budgets and gameplay visibility tests.
