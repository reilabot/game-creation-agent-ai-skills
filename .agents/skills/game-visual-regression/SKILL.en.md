...
description: Create deterministic visual states and compare screenshots across builds, devices, resolutions, and quality levels. Use for visual regression testing.
---
...
5. Produce baselines, tolerances, diffs and human review gate.
