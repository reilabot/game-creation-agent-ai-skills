---
name: game-responsive-ui
description: Adapt UI to resolution, aspect ratio, safe area, DPI, density, input method, and localization. Use for responsive game UI.
---
...
5. Produce layout constraints and device/resolution matrix.
