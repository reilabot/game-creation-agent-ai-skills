---
name: game-post-processing
description: Use bloom, grading, depth, exposure, and motion effects without hiding game state. Use for post-processing.
---
...
5. Produce volume profiles, accessibility toggles, GPU captures.
