---
name: game-build-ci-cd
description: Build reproducible game CI/CD with pinned toolchains, caching, tests, signing boundaries, artifacts, and promotion gates. Use for automated builds and delivery.
---
...
5. Produce pipeline definition, immutable artifacts and rollback procedure.
