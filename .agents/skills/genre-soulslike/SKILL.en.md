---
name: genre-soulslike
description: Design deliberate stamina combat, telegraphs, checkpoints, recovery loops, bosses, and build progression. Use for soulslike games.
---
...
5. Produce combat contract, encounter rules, fairness playtests.
