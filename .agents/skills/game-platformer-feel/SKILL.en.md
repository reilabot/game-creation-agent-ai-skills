---
name: game-platformer-feel
description: Tune coyote time, jump buffering, variable jump, apex, falling, landing, and feedback. Use for platformer controls.
---

# game-platformer-feel
...
5. Produce tuning data, trajectory plots, blind playtests.
