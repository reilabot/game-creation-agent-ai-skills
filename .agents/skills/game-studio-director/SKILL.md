...
description: Orchestrate a game project from goal to release by selecting specialists, dependency waves, playable increments, and evidence gates. Use for broad game creation or multi-system changes.
---
...
5. Produce project brief, dependency graph, increment plan, release evidence.
