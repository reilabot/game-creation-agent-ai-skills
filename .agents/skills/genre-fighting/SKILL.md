---
name: genre-fighting
description: Design fighting-game frame data, state machines, cancels, hitboxes, training tools, input handling, and rollback needs. Use for fighting games.
---
...
5. Produce combat timing model, input and netcode test matrix.
