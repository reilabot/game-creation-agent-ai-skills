---
name: genre-city-builder
description: Design zoning, placement, services, traffic, resources, citizen feedback, and city simulation. Use for city builders.
---
...
5. Produce simulation graph, build loop, readability and scale checks.
