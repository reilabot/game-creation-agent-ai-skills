---
name: genre-rts
description: Design real-time strategy economy, unit control, fog, pathfinding, combat simulation, and deterministic replay. Use for RTS games.
---
...
5. Produce simulation rules, command model, AI and scale budgets.
