---
name: genre-party-game
description: Design quick onboarding, short rounds, local/online join, fairness, accessibility, and spectator-readable chaos. Use for party games.
---
...
5. Produce round contract, join/recovery flows, mixed-device tests.
