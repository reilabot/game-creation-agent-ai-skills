---
name: game-audio
description: Design music, ambience, dialogue, SFX, mixing, buses, spatial audio, accessibility, and runtime budgets. Use for game audio systems.
---
...
5. Produce audio event map, loudness/mix targets, device and runtime tests.
