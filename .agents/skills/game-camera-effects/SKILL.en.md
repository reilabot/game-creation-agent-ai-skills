---
name: game-camera-effects
description: Design shake, impulse, zoom, FOV, framing, and transitions driven by gameplay events. Use for camera effects.
---
...
5. Produce impulse contract, envelopes, comfort and collision tests.
