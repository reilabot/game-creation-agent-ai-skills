---
name: game-ui-effects
description: Design UI particles, selection, reward, notification, and rarity effects that preserve legibility. Use for UI effects.
---
...
5. Produce effect hierarchy, motion alternatives, performance tests.
