---
name: game-audio-visual-sync
description: Synchronize animation, VFX, SFX, music, camera, and haptics through shared semantic events. Use for cross-modal feedback.
---

# game-audio-visual-sync
...
5. Produce feedback event schema, timing offsets and capture validation.
