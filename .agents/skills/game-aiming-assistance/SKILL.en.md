---
name: game-aiming-assistance
description: Design aim assist, target selection, dead zones, sensitivity, gyro, and fairness controls. Use for aiming.
---

# game-aiming-assistance
...
5. Produce assist policy, tunable curves, device and skill-level tests.
