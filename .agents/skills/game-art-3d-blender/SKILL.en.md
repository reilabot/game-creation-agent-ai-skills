---
name: game-art-3d-blender
description: Plan 3D Blender assets with scale, topology, UVs, materials, rigs, LODs, collision, export, and provenance. Use for 3D asset pipelines.
---
...
5. Produce asset contract, export preset, engine import and visual QA.
