---
name: gamedev-quality-gate
description: Gate playable increments and releases using functional, visual, performance, accessibility, persistence, networking, and platform evidence. Use before accepting a game increment or build.
---

# gamedev-quality-gate
...
5. Produce pass/fail report with reproducible evidence and fix loop.
