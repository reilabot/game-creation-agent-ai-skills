...
description: Plan functional QA, exploratory playtests, telemetry, bug reproduction, compatibility, and release triage. Use for playable increments.
---
...
5. Produce risk-based matrix, sessions, evidence and triaged defects.
