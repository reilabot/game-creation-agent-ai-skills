---
name: genre-racing
description: Design vehicle handling, tracks, racing rules, AI lines, assists, timing, and camera feedback. Use for racing games.
---
...
5. Produce handling targets, track metrics, assist and latency tests.
