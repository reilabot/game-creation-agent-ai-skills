---
name: game-player-controller
description: Implement tunable movement, acceleration, turning, slopes, air control, collision, and state transitions. Use for player controllers.
---
...
5. Produce movement model, parameter asset, edge-case tests.
