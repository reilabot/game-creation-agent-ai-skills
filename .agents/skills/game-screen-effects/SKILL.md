---
name: game-screen-effects
description: Design vignette, flash, damage direction, and low-health screen effects with accessibility controls. Use for screen-space feedback.
---
...
5. Produce priority stack, intensity caps, comfort tests.
