---
name: gamedev-project-analyzer
description: Inspect an existing or proposed game project and determine engine, language, dimensions, platforms, multiplayer mode, tools, risks, and missing evidence. Use before routing substantial game work.
---
...
5. Produce evidence-based project profile and uncertainty list.
