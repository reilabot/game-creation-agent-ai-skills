---
name: game-rollback-netcode
description: Design deterministic rollback, input prediction, snapshots, resimulation, delay policy, and desync detection. Use for latency-sensitive peer matches.
---

# game-rollback-netcode
...
5. Produce rollback budget, deterministic harness, latency and desync tests.
