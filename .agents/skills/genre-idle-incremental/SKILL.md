---
name: genre-idle-incremental
description: Design offline progress, generators, prestige, curves, caps, time integrity, and automation. Use for idle or incremental games.
---
...
5. Produce economy formulas, offline simulation and exploit tests.
