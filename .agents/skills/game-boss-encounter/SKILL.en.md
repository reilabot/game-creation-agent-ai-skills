---
name: game-boss-encounter
description: Design readable boss phases, telegraphs, arenas, transitions, recovery, rewards, and accessibility. Use for boss encounters.
---
...
5. Produce phase graph, timing sheet, fairness and performance captures.
