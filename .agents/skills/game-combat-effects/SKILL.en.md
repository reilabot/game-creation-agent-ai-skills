---
name: game-combat-effects
description: Design hit, critical, guard, parry, heal, and status effects tied to authoritative events. Use for combat VFX.
---
...
5. Produce event mapping, priority, timing and clutter tests.
