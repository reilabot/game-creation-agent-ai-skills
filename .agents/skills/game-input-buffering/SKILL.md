---
name: game-input-buffering
description: Implement input buffers, queues, priorities, cancel windows, expiry, and debugging. Use for timing-sensitive controls.
---
...
5. Produce buffer contract, timing parameters, frame-step tests.
