---
name: game-hit-feedback
description: Layer hit stop, shake, flash, knockback, impact frames, sound, and haptics from shared events. Use for impact feedback.
---
...
5. Produce feedback recipe, priority/caps, slow-motion capture tests.
