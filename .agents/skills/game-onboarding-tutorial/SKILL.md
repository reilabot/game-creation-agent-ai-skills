---
name: game-onboarding-tutorial
description: Design progressive onboarding, contextual hints, practice, skip/replay, and learning validation. Use for tutorials.
---
...
5. Produce learning objectives, trigger rules, comprehension playtests.
