---
name: game-hud-design
description: Design readable combat, exploration, and status HUDs across devices and aspect ratios. Use for HUD work.
---
...
5. Produce HUD states, readability tests, safe-zone layouts.
