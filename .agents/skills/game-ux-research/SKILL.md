---
name: game-ux-research
description: Run usability studies using task success, behavior logs, comprehension, and drop-off evidence. Use to validate game UX.
---
...
5. Produce study plan, observations, findings and prioritized changes.
