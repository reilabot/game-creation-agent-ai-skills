---
name: game-combat-feel
description: Tune startup, active, recovery, combos, cancels, parries, hit reactions, and readable timing. Use for action combat feel.
---
...
5. Produce frame/timing data, event hooks, fairness playtests.
