---
name: genre-extraction-shooter
description: Design raid loops, extraction, authoritative inventory, risk/reward, matchmaking, anti-cheat, and loss recovery. Use for extraction shooters.
---
...
5. Produce raid state model, economy sinks, security and recovery tests.
