---
name: game-network-prediction
description: Design client prediction, reconciliation, interpolation, lag compensation, and correction presentation. Use for real-time online movement or combat.
---
...
5. Produce timeline model, authority rules, impairment tests.
