---
name: genre-colony-sim
description: Design agent needs, jobs, scheduling, resources, incidents, and emergent colony stories. Use for colony simulations.
---
...
5. Produce agent model, job arbitration, incident and performance tests.
