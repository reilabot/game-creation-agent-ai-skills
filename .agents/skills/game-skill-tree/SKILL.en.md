---
name: game-skill-tree
description: Design unlock graphs, prerequisites, respec, modifiers, UI presentation, persistence, and migration. Use for skill trees.
---
...
5. Produce acyclic graph, effect contract, save/version tests.
