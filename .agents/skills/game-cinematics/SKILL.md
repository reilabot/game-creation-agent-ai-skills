---
name: game-cinematics
description: Design cutscenes, timelines, camera blocking, gameplay handoff, skip, and checkpoint behavior. Use for cinematics.
---
...
5. Produce sequence plan, state handoff, skip and localization tests.
