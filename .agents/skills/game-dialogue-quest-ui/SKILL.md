---
name: game-dialogue-quest-ui
description: Design dialogue, choices, quest tracking, subtitles, and history. Use for narrative UI.
---

# game-dialogue-quest-ui
...
5. Produce content states, subtitle rules, accessibility tests.
