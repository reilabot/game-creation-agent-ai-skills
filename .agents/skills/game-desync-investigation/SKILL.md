---
name: game-desync-investigation
description: Capture and localize multiplayer desynchronization using deterministic logs, hashes, replay, binary search, and network impairment. Use for state divergence.
---

# game-desync-investigation
...
5. Produce minimal reproduction, first divergent tick and verified fix.
