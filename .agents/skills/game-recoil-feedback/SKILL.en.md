---
name: game-recoil-feedback
description: Tune weapon, camera, reticle, spread, recovery, sound, VFX, and haptics recoil. Use for weapon feedback.
---

# game-recoil-feedback
...
5. Produce recoil curves, recovery rules, input/device tests.
