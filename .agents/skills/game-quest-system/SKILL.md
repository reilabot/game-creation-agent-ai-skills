...
description: Design data-driven quests, objectives, branching, rewards, failure, persistence, and migration. Use for quest systems.
---
...
5. Produce quest schema, state transitions, save and regression tests.
