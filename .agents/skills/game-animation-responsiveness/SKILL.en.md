---
name: game-animation-responsiveness
description: Reduce perceived animation latency through blend tuning, root-motion policy, anticipation, cancel rules, and event timing. Use for responsive animation.
---

# game-animation-responsiveness
...
5. Produce latency budget, transition profiles, frame-step evidence.
