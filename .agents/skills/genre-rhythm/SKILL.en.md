---
name: genre-rhythm
description: Design beat maps, timing windows, calibration, latency compensation, scoring, and audio synchronization. Use for rhythm games.
---
...
5. Produce timing contract, calibration flow, sync evidence.
