---
name: genre-gacha-live-service
description: Design transparent gacha probabilities, pity, currencies, content cadence, entitlements, and live-service economy. Use for gacha systems; require legal and publishing review.
---

# genre-gacha-live-service
...
5. Produce economy model, disclosure, simulation, rollback and approval gates.
