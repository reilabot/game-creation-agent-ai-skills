---
name: game-vfx-direction
description: Define a coherent VFX language for color, shape, timing, hierarchy, and gameplay readability. Use when directing game effects.
---
...
5. Produce VFX bible, semantic palette, readability rules.
