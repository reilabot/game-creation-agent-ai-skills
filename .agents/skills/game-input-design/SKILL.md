---
name: game-input-design
description: Design action maps, rebinding, device switching, conflicts, prompts, and persistence. Use for input architecture.
---
...
5. Produce input map, conflict rules, device and accessibility tests.
