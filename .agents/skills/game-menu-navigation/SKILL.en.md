---
name: game-menu-navigation
description: Design keyboard, mouse, gamepad, and touch navigation with focus recovery. Use for menus and settings.
---
...
5. Produce navigation graph, focus rules, mixed-input tests.
