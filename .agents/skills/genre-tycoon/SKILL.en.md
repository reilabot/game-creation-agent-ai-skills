---
name: genre-tycoon
description: Design business operations, customer flow, pricing, upgrades, staffing, and financial progression. Use for tycoon games.
---
...
5. Produce economy loop, demand model, dashboards and balance tests.
