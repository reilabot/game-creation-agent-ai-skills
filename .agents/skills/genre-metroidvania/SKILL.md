...
description: Design ability-gated exploration, interconnected maps, backtracking rewards, traversal, and progression. Use for metroidvania games.
---
...
5. Produce ability graph, map gates, sequence-break tests.
