---
name: game-haptics
description: Design vibration, rumble, adaptive trigger, and mobile haptics with priorities and user controls. Use for tactile feedback.
---
...
5. Produce semantic haptic events, device fallbacks, comfort tests.
