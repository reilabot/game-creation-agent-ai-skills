---
name: genre-moba
description: Design lanes, objectives, heroes, abilities, items, vision, matchmaking, and authoritative team combat. Use for MOBAs.
---
...
5. Produce match flow, content schema, balance telemetry.
