---
name: game-particle-effects
description: Implement particles, trails, decals, emitters, pooling, and deterministic triggers. Use for particle effects.
---
...
5. Produce effect prefab contract, budgets, pooling and capture tests.
