---
name: game-lock-on-targeting
description: Implement lock-on, target scoring, cycling, occlusion, camera coordination, and release rules. Use for target lock systems.
---

# game-lock-on-targeting
...
5. Produce selection model, camera contract, crowded-scene tests.
