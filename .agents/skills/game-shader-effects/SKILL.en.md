---
name: game-shader-effects
description: Implement surface, dissolve, outline, damage, and environment shaders with fallbacks. Use for gameplay shader effects.
---
...
5. Produce parameter contract, variants, performance and readability tests.
