---
name: genre-sports
description: Design sport rules, player/team simulation, controls, officiating, AI tactics, seasons, and presentation. Use for sports games.
---
...
5. Produce rules model, control scheme, AI and replay validation.
