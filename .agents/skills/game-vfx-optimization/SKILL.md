---
name: game-vfx-optimization
description: Measure and reduce VFX overdraw, particles, variants, memory, and spikes using platform budgets. Use when effects threaten performance.
---

# game-vfx-optimization
...
5. Produce budget table, captures, LOD/pooling plan and before/after data.
